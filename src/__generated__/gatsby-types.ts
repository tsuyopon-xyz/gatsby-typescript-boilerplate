...
type SitePageContext = {
  readonly product: Maybe<SitePageContextProduct>;
};

type SitePageContextFilterInput = {
  readonly product: Maybe<SitePageContextProductFilterInput>;
};

type SitePageContextProduct = {
  readonly title: Maybe<Scalars['String']>;
  readonly images: Maybe<ReadonlyArray<Maybe<SitePageContextProductImages>>>;
  readonly shopifyId: Maybe<Scalars['String']>;
  readonly handle: Maybe<Scalars['String']>;
  readonly description: Maybe<Scalars['String']>;
  readonly availableForSale: Maybe<Scalars['Boolean']>;
  readonly priceRange: Maybe<SitePageContextProductPriceRange>;
};

type SitePageContextProductFilterInput = {
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly images: Maybe<SitePageContextProductImagesFilterListInput>;
  readonly shopifyId: Maybe<StringQueryOperatorInput>;
  readonly handle: Maybe<StringQueryOperatorInput>;
  readonly description: Maybe<StringQueryOperatorInput>;
  readonly availableForSale: Maybe<BooleanQueryOperatorInput>;
  readonly priceRange: Maybe<SitePageContextProductPriceRangeFilterInput>;
};

type SitePageContextProductImages = {
  readonly originalSrc: Maybe<Scalars['String']>;
};

type SitePageContextProductImagesFilterInput = {
  readonly originalSrc: Maybe<StringQueryOperatorInput>;
};

type SitePageContextProductImagesFilterListInput = {
  readonly elemMatch: Maybe<SitePageContextProductImagesFilterInput>;
};

type SitePageContextProductPriceRange = {
  readonly maxVariantPrice: Maybe<SitePageContextProductPriceRangeMaxVariantPrice>;
  readonly minVariantPrice: Maybe<SitePageContextProductPriceRangeMinVariantPrice>;
};

type SitePageContextProductPriceRangeFilterInput = {
  readonly maxVariantPrice: Maybe<SitePageContextProductPriceRangeMaxVariantPriceFilterInput>;
  readonly minVariantPrice: Maybe<SitePageContextProductPriceRangeMinVariantPriceFilterInput>;
};

type SitePageContextProductPriceRangeMaxVariantPrice = {
  readonly amount: Maybe<Scalars['String']>;
};

type SitePageContextProductPriceRangeMaxVariantPriceFilterInput = {
  readonly amount: Maybe<StringQueryOperatorInput>;
};

type SitePageContextProductPriceRangeMinVariantPrice = {
  readonly amount: Maybe<Scalars['String']>;
};

type SitePageContextProductPriceRangeMinVariantPriceFilterInput = {
  readonly amount: Maybe<StringQueryOperatorInput>;
};
...
enum SitePageFieldsEnum {
  ...
  context___product___title = 'context.product.title',
  context___product___images = 'context.product.images',
  context___product___images___originalSrc = 'context.product.images.originalSrc',
  context___product___shopifyId = 'context.product.shopifyId',
  context___product___handle = 'context.product.handle',
  context___product___description = 'context.product.description',
  context___product___availableForSale = 'context.product.availableForSale',
...
type usersTsuyoshiDocumentsjavascriptpracticegatsbygatsbyTypscriptSamplesrcpagesproductsTsx3708707325QueryVariables = Exact<{ [key: string]: never; }>;


type usersTsuyoshiDocumentsjavascriptpracticegatsbygatsbyTypscriptSamplesrcpagesproductsTsx3708707325Query = { readonly allShopifyProduct: (
    Pick<ShopifyProductConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ShopifyProduct, 'id' | 'title' | 'handle' | 'shopifyId' | 'description' | 'availableForSale'>
        & { readonly images: Maybe<ReadonlyArray<Maybe<Pick<ShopifyProductImages, 'originalSrc'>>>>, readonly priceRange: Maybe<{ readonly maxVariantPrice: Maybe<Pick<ShopifyProductPriceRangeMaxVariantPrice, 'amount' | 'currencyCode'>>, readonly minVariantPrice: Maybe<Pick<ShopifyProductPriceRangeMinVariantPrice, 'amount' | 'currencyCode'>> }> }
      ) }> }
  ) };
...
type usersTsuyoshiDocumentsjavascriptpracticegatsbygatsbyTypscriptSamplesrccomponentsImageTsx1132682437QueryVariables = Exact<{ [key: string]: never; }>;


type usersTsuyoshiDocumentsjavascriptpracticegatsbygatsbyTypscriptSamplesrccomponentsImageTsx1132682437Query = { readonly placeholderImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> };

type usersTsuyoshiDocumentsjavascriptpracticegatsbygatsbyTypscriptSamplesrccomponentsSeoTsx63159454QueryVariables = Exact<{ [key: string]: never; }>;


type usersTsuyoshiDocumentsjavascriptpracticegatsbygatsbyTypscriptSamplesrccomponentsSeoTsx63159454Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };
